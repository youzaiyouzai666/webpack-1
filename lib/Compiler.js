...
class Compiler extends Tapable {
	constructor() {
		...
		this.inputFileSystem = null;//输入输出控制，NodeEnvironmentPlugin中初始化
		...
		this.options = {};//webpack 配置 ./lib/webpack.js 中写入
	}
	...
	compile(callback) {
		...
		this.applyPluginsAsync("before-compile", params, err => {
			...
			const compilation = this.newCompilation(params);//创建 compilation
